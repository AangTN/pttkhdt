...
public class DAOQuanLy {
    ...
    public ArrayList<May> layDanhSachMayThuong() {
        ...
        String truyVan = "SELECT * FROM May WHERE LoaiMay = N'Thường' ORDER BY CAST(IDMay AS INT) ASC  ";
        try {
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery(truyVan);
            while (rs.next()) {
    ...
    public ArrayList<May> layDanhSachMayVIP() {
        ArrayList<May> ds = new ArrayList<>();
        String truyVan = "SELECT * FROM May WHERE LoaiMay = 'VIP' ORDER BY CAST(IDMay AS INT) ASC";
        try {
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery(truyVan);
            while (rs.next()) {
    ...
    public String tatMay(String idMay) {
        String truyVan = "UPDATE May SET TrangThai = 'off', IDTaiKhoan = ? WHERE IDMay = ?";
        try {
            PreparedStatement stmt = con.prepareStatement(truyVan);
