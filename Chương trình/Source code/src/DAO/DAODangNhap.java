...
public class DAODangNhap {
    ...
    public String kiemTraDangNhap(String username, String pass){
        ...
        try {
            ...
            if(rs.next()){
                if(rs.getString("MatKhau").trim().equals(pass)) {
                    if(rs.getString("TrangThai").trim().equals("Khóa")) return "Tài khoản đã bị khóa";
                    return "Thành công:"+ rs.getString("IDTaiKhoan");
                }
